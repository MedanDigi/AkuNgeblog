...
//membuat code untuk validasi email
...
//mendapatkan avatar berdasarkan avatar
if(!function_exists('get_gravatar')) {
     ...
     */
    function get_gravatar($email, $s = 250, $d = 'mm', $r = 'g', $img = false, $atts = array())
    {
